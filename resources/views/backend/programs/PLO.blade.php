            ...
            <form class="form" id="plo_submit_Fundamental">
                ...
                <div class="d-flex justify-content-between">
                    <button class="btn btn-sm btn-secondary" type="button" onclick="add_more_fundamental()">Add
                        More</button>
                    <a>
                        <button class="btn btn-primary fundamental_submit_button" id="plo_submit_Fundamental">Save</button>
                    </a>
                </div>
            </form>
        </div>
        <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <form class="form" id="plo_submit_Social">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a>
                        <button class="btn btn-primary social_submit_button" id="plo_submit_Social">Save</button>
                    </a>
                </div>
            </form>
        </div>
            ...
            <form class="form" id="plo_submit_Thinking">
                ...
                <div class="d-flex justify-content-between">
                    <button class="btn btn-sm btn-secondary" type="button" onclick="add_more_thinking()">Add
                        More</button>
                    <a>
                        <button class="btn btn-primary thinking_submit_button" id="plo_submit_Thinking">Save</button>
                    </a>
                </div>
            </form>
        </div>
            ...
            <form class="form" id="plo_submit_Personal">
                ...
                <div class="d-flex justify-content-between">
                    <button class="btn btn-sm btn-secondary" type="button" onclick="add_more_personal()">Add
                        More</button>
                    <a>
                        <button class="btn btn-primary personal_submit_button" id="plo_submit_Personal">Save</button>
                    </a>
                </div>
            </form>
        </div>
