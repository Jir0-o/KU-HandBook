<div class="card p-lg-4 p-2">
    <form class="form" id="submit-content">
        ...
        <div class="d-flex justify-content-between">
            <button class="btn btn-sm btn-secondary" type="button" onclick="more_map_clo()">Add More</button>
            <a>
                <button class="btn btn-primary content-submit_button" type="submit" id="submit-content">Save</button>
            </a>
        </div>
    </form>
</div>
